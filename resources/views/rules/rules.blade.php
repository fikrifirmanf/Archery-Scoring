            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td>{{$r->nama_kategori}}</td>
                  ...
                  <td>{{$r->jml_panah}}</td>
                  <td>{{$r->jml_peserta}}</td>
                <td><a href="/rules/edit/{{$r->uuid}}"><button class="btn btn-warning mr-2"><i class="fas fa-edit"></i></button></a><a href="#"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a></td>
